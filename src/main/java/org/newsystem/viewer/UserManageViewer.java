...
public class UserManageViewer {
    ...
    public String viewForAddUserInfo(OneUserInfo userInfo) {
        String metadataView = String.format("added firstName is %s, and lastName is %s.", userInfo.getFirstName(), userInfo.getLastName());
